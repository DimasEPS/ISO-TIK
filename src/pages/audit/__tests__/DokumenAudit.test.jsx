...
describe('DokumenAudit Integration', () => {
  ...
  describe('Initial Load', () => {
    it('should display loading state initially', async () => {
      vi.mocked(auditService.listDocuments).mockImplementation(() => new Promise(() => {})); // Never resolves
      renderComponent();
    ...
    it('should display error message when API fails', async () => {
      vi.mocked(auditService.listDocuments).mockRejectedValue(new Error('Network error'));
      renderComponent();
  ...
  describe('Search Functionality', () => {
    it('should search documents by title', async () => {
      ...
      const searchInput = screen.getByPlaceholderText(/cari judul dokumen audit/i);
  ...
  describe('UPDATE Operation', () => {
    it('should update document successfully', async () => {
      ...
      await waitFor(() => {
        expect(auditService.updateDocument).toHaveBeenCalledWith(
          '1',
          { title: 'Updated Title' }
        );
      });
  ...
  describe('PDF Export', () => {
    ...
    it('should show loading spinner during PDF download', async () => {
      auditDocumentPDF.downloadAuditDocumentPDF.mockImplementation(() => new Promise(() => {}));
      const user = userEvent.setup();
      renderComponent();
  ...
  describe('Error Handling', () => {
    it('should handle create error gracefully', async () => {
      vi.mocked(auditService.createDocument).mockRejectedValue(new Error('Create failed'));
      const user = userEvent.setup();
      renderComponent();
    ...
    it('should handle update error gracefully', async () => {
      vi.mocked(auditService.updateDocument).mockRejectedValue(new Error('Update failed'));
      const user = userEvent.setup();
      renderComponent();
    ...
    it('should handle delete error gracefully', async () => {
      vi.mocked(auditService.deleteDocument).mockRejectedValue(new Error('Delete failed'));
      const user = userEvent.setup();
      renderComponent();
  ...
  describe('Empty State', () => {
    it('should handle empty data gracefully', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.queryByText(/memuat data audit/i)).not.toBeInTheDocument();
      });
    });
  });
